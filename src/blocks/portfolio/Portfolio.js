                        ...
                        <div className="portfolio-item" key={key}>
                            ...
                            {item.heroImg ? (
                                <div className={"portfolio-hero portfolio-hero-img" + (item.heroImgOnGradient ? " on-gradient" : "")}
                                    ...
                                    {item.heroLeft && <span className="hero-flank" dangerouslySetInnerHTML={{__html: item.heroLeft}} />}
                                    ...
                                    {item.heroRight && <span className="hero-flank" dangerouslySetInnerHTML={{__html: item.heroRight}} />}
                                </div>
                            ) : (
